...
?>
            ...
            <div class = "contenido_div">
                <div class = "margen_contenido">
                    ...
                    <div class = "titulo_contenido">
                        <a><i class='bx bxs-user'></i>Mantenimiento Nivel</a>
                    </div>
                    <!--AQUI VA EL TABLE Y LO DEMAS-->
                    <div id="divListadoNiveles"></div>
    ...
    <?php include ("../../modal/nivelModal.php")?>

    <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
    <script src="../../assets/js_sge/nivelAcademico.js"></script>
    <script>
